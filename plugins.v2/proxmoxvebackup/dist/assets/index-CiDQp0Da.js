...
import PageComponent from './__federation_expose_Page-B3ltjF4X.js';
import ConfigComponent from './__federation_expose_Config-CibaufPw.js';
import DashboardComponent from './__federation_expose_Dashboard-D-UPLQch.js';
...
const mockPluginApiWrapper = {
  get: async (url) => {
    // 简单模拟GET请求，支持config/status/installed_plugins
    ...
    if (url.includes('installed_plugins')) {
      return JSON.parse(JSON.stringify(mockDatabase.installed_plugins));
    }
    return {};
  },
  post: async (url, data) => {
    // 简单模拟POST请求，支持config保存
    if (url.includes('config')) {
      Object.assign(mockDatabase.config, data);
      showNotification('配置已在Mock API中更新', 'success');
      return { message: '配置已成功保存 (模拟)', saved_config: JSON.parse(JSON.stringify(mockDatabase.config)) };
    }
    return {};
  }
};
...
const setupMockFetch = () => {
  ...
  window.fetch = async (url, options = {}) => {
    ...
    // 匹配插件API请求
    if (url.includes('/api/v1/plugin/PVEGuardian/')) {
      const endpoint = url.split('/api/v1/plugin/PVEGuardian/')[1];
...
onMounted$f(async () => {
  try {
    ...
    // 加载初始配置
    const configResponse = await fetch('/api/v1/plugin/PVEGuardian/config');
    const configData = await configResponse.json();
    if (configData) Object.assign(mockDatabase.config, configData);

    // 加载状态数据
    const statusResponse = await fetch('/api/v1/plugin/PVEGuardian/status');
    const statusData = await statusResponse.json();
    if (statusData) Object.assign(mockDatabase.status, statusData);
    
    // 加载插件列表
    const pluginsResponse = await fetch('/api/v1/plugin/PVEGuardian/installed_plugins');
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createVNode$2k(_component_v_app, null, {
      default: _withCtx(() => [
          ...
          default: _withCtx(() => [
            _createVNode$2k(_component_v_app_bar_title, null, {
              default: _withCtx(() => _cache[10] || (_cache[10] = [
                _createTextVNode$7("PVE虚拟机守护神")
              ])),
              _: 1
            }),
            _createVNode$2k(_component_v_spacer),
            _createVNode$2k(_component_v_btn, {
              text: "",
              onClick: _cache[0] || (_cache[0] = $event => (activeTab.value = 'page')),
              disabled: activeTab.value === 'page'
            }, {
              default: _withCtx(() => _cache[11] || (_cache[11] = [
                _createTextVNode$7("状态页")
              ])),
              _: 1
            }, 8, ["disabled"]),
            _createVNode$2k(_component_v_btn, {
              text: "",
              onClick: _cache[1] || (_cache[1] = $event => (activeTab.value = 'config')),
              disabled: activeTab.value === 'config'
            }, {
              default: _withCtx(() => _cache[12] || (_cache[12] = [
                _createTextVNode$7("配置")
              ])),
              _: 1
            }, 8, ["disabled"])
          ]),
                ...
                _createVNode$2k(_component_v_window, {
                  ...
                  default: _withCtx(() => [
                    _createVNode$2k(_component_v_window_item, { value: "page" }, {
                      default: _withCtx(() => [
                        _cache[16] || (_cache[16] = _createElementVNode("h2", { class: "text-h5 mb-4" }, "运行状态与操作 (Page.vue)", -1)),
                        _createElementVNode("div", _hoisted_2, [
                          _createVNode$2k(PageComponent, {
                            api: mockPluginApiWrapper,
                            onSwitch: switchToConfig,
                            onClose: _cache[3] || (_cache[3] = $event => (handleClose('Page')))
                          })
                        ])
                      ]),
                      _: 1
                    ...
                    _createVNode$2k(_component_v_window_item, { value: "config" }, {
                      default: _withCtx(() => [
                        _cache[17] || (_cache[17] = _createElementVNode("h2", { class: "text-h5 mb-4" }, "插件配置 (Config.vue)", -1)),
                        _createElementVNode("div", _hoisted_3, [
                          _createVNode$2k(ConfigComponent, {
                            ...
                            onClose: _cache[4] || (_cache[4] = $event => (handleClose('Config'))),
                    ...
                    _createVNode$2k(_component_v_window_item, { value: "dashboard" }, {
                      default: _withCtx(() => [
                        _cache[18] || (_cache[18] = _createElementVNode("h2", { class: "text-h5 mb-4" }, "仪表盘组件 (Dashboard.vue)", -1)),
                            ...
                            _createVNode$2k(_component_v_col, {
                              ...
                              default: _withCtx(() => [
                                _createVNode$2k(_component_v_switch, {
                                  ...
                                  "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((dashboardWidgetConfig.attrs.border) = $event)),
                                  label: "显示边框",
                                  color: "primary",
                                  density: "compact",
                                  class: "mb-n4"
                            ...
                            _createVNode$2k(_component_v_col, {
                              ...
                              default: _withCtx(() => [
                                _createVNode$2k(_component_v_text_field, {
                                  ...
                                  "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((dashboardWidgetConfig.attrs.title) = $event)),
                                  label: "组件标题",
                                  variant: "outlined",
                                  density: "compact"
                                }, null, 8, ["modelValue"])
        ...
        _createVNode$2k(_component_v_footer, {
          ...
          default: _withCtx(() => [
            _createElementVNode("span", _hoisted_5, "MoviePilot PVE虚拟机守护神本地测试 ©" + _toDisplayString(new Date().getFullYear()), 1)
          ]),
          _: 1
        })
      ]),
    ...
    _createVNode$2k(_component_v_snackbar, {
      ...
      actions: _withCtx(() => [
        _createVNode$2k(_component_v_btn, {
          variant: "text",
          onClick: _cache[8] || (_cache[8] = $event => (snackbar.show = false))
        }, {
...
const App = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-d02a115b"]]);
