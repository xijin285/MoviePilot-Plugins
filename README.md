...
> 🎨 优化UI布局，与备份功能保持一致的设计风格。

<details>
<summary>历史更新</summary>

- `v1.2.1`：🔧 修复FastAPI路由注册问题，解决插件加载错误。🎯 优化API接口配置，提升插件稳定性。
...
- `v2.1.2`：🔒 修复WebDAV密码显示按钮问题，提升配置安全性与体验。💾 保留备份支持全部备份类型（本地+WebDAV）。🔄 立即恢复支持远程(WebDAV)备份恢复，一键恢复云端备份。
- `v2.1.1`：🐛 修复未填容器ID时备份逻辑问题。🧹 新增手动执行清理PVE系统临时空间。📱 移动端细节UI与交互适配。
...
> 🛠️ **修复v6内存异常问题**  
> 🎨 **优化状态页检测站点颜色动态显示**  
> - 新增tracker优选功能，支持更全面的IP优选策略  
> - 修复IPv6环境下内存异常问题，提升稳定性  
