...
| 3 | [🖥️ PVE虚拟机守护神 (ProxmoxVEBackup)](#pve虚拟机守护神-proxmoxvebackup) | v2.3.3 | 全面的PVE虚拟化管理与备份方案 | 虚拟化/备份 |
| 4 | [🔧 OpenWrt路由备份助手 (OpenWrtBackup)](#openwrt路由备份助手-openwrtbackup) | v1.1.0 | 全自动的OpenWrt配置备份方案 | 网络/备份 |
| 5 | [🌐 爱快路由备份助手 (IkuaiRouterBackup)](#爱快路由备份助手-ikuairouterbackup) | v1.3.3 | 轻松配置您的爱快路由，让路由管理更简单 | 网络/备份 |
